...
dgx-spark-cli vendors its `.claude/skills/` from **guildmaster** — the
...
#   - consumer-identifying prose: `guildmaster` → `dgx-spark-cli` (NOT
...
If a re-sync would lose a dgx-spark-cli adaptation, lift the change
