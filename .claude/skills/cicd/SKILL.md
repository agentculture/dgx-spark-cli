...
type: command
description: >
  dgx-spark-cli's CI/CD lane, layered on `agex pr`. Delegates lint / open /
  ...
  unresolved threads). Use when: creating PRs in dgx-spark-cli, handling
