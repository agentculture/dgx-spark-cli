...
Every failure inside dgx-spark-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`spark.cli._output`,
...
# Exit-code policy. Documented in ``dgx-spark-cli learn`` output.
# 0      = success
