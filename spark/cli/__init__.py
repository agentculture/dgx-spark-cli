...
from spark.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/dgx-spark-cli/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    from spark.cli._commands import cli as _cli_group
    ...
    parser = _CliArgumentParser(
        prog="dgx-spark-cli",
        description="dgx-spark-cli — a clonable template for AgentCulture mesh agents.",
    )
    parser.add_argument(
        "--version",
        action="version",
